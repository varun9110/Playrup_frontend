      ...
      <header className="bg-background/80 backdrop-blur-sm border-b sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">PlayC Dashboard</h1>
              <p className="text-muted-foreground">Welcome back! Ready to play?</p>
            </div>
            <div className="flex gap-2">
              <Button asChild>
                <Link to="/playc/book">Book Court</Link>
              </Button>
              <Button variant="outline" asChild>
                <Link to="/playc/activities">Browse Activities</Link>
              </Button>
            </div>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="outline" className="w-full" asChild>
                <Link to="/playc/my-bookings">View All Bookings</Link>
              </Button>
            </CardContent>
          </Card>
